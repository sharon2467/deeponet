...
parser.add_argument('--mode', type=str, metavar='--', choices=['train', 'eval'],default='train',)
...
parser.add_argument('--logdir', type=str, default='./log/', metavar='--',
                    help='log dir')
parser.add_argument('--model_type',default='DeepONet',type=str, metavar='--', choices=['DeepONet','DeepONet_Conv'],)
parser.add_argument('--order',type=int,metavar='--',default=1,help='order of the field')
